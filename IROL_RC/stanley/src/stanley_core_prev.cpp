...
namespace waypoint_follower
{
    ...
    double StanleyNode::computeCommandSteeringAngle() const
    {
        ...
        // 1) heading_error
        // Euler
        const double target_heading = getYaw(target_pose);
        const double current_heading = getYaw(current_pose);
        ...
        // const double cross_track_error = 0;
        ...
        return heading_error + atan(control_gain_ * cross_track_error / current_linear_velocity_);
    }
