...
#ifndef STANLEY_STANLEY_VIZ_H
#define STANLEY_STANLEY_VIZ_H
...
namespace waypoint_follower
{
    ...
    visualization_msgs::Marker displayNextWaypoint(geometry_msgs::Pose pose);
    // display the next target by markers.
    visualization_msgs::Marker displayNextTarget(geometry_msgs::Pose target);
    // display the closest waypoint by markers.
    visualization_msgs::Marker displayClosestWaypoint(geometry_msgs::Pose pose);
